...
namespace Library.Services
{
    public class BookService
    {
        ...
        public List<GetBoksViewModel> GetBooks()
        {
            return _books.Select(x => new GetBoksViewModel { Id = x.Id, Type = PublicationType.Book.ToString(), Name = x.Publication.Name, Author = x.Author }).ToList();
